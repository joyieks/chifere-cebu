-- Simple step-by-step script to create review and follow system
...
-- Step 3: Create seller_stats table
...
-- Step 8: Create RLS policies for seller_stats
...
-- Step 9: Create functions (run this as one block)
...
-- Step 11: Insert initial seller stats (only for real users)
-- This will only insert stats for sellers that actually exist in auth.users
