-- Fix Missing Orders Table
-- This script safely creates only what's missing without conflicts
...
-- Step 2: Create the order_items table if it doesn't exist
...
-- Step 3: Create the order_status_history table if it doesn't exist
...
-- Step 4: Create the order_notifications table if it doesn't exist
...
-- Step 6: Create functions if they don't exist
...
-- Step 7: Drop and recreate trigger to avoid conflicts
...
-- Success message
SELECT 'Orders table and checkout system created successfully!' as message;
