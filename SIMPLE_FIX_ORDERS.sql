-- SIMPLE FIX ORDERS - Fixed version without role column

-- Step 1: Show orders with NULL seller_id before fix
...
-- Step 4: Alternative fix - try seller_add_item_preloved
UPDATE buyer_orders 
SET seller_id = (
